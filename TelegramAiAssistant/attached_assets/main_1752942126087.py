...
from handlers import menu, orders, sponsor, recruitment, admin, fallback
...
class KrustyKrabBot:
    ...
    async def setup_bot_commands(self):
        ...
        commands = [
            ...
            BotCommand(command="modifica_menu", description="⚙️ Modifica menù (Admin)"),
    ...
    async def setup_staff_group(self):
        ...
        try:
            ...
            if not staff_group_id:
                ...
                logger.info("4. Get the group ID and use /admin command to configure it")
    ...
    async def register_handlers(self):
        ...
        # Register handlers from modules (order is important)
        ...
        # Register fallback handler LAST to catch all unhandled messages
